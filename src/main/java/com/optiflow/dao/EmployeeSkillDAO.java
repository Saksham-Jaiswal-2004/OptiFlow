...
public class EmployeeSkillDAO
{
    ...
    {
        String sql = "INSERT INTO employeeskill (emp_id, skill_id, proficiency) VALUES (?, ?, ?)";
    ...
    public List<Skills> getSkillsByEmployee(int emp_id) throws SQLException
    {
        ...
        String sql = "SELECT * FROM employeeskill WHERE emp_id=?";
    ...
    {
        String sql = "UPDATE employeeskill SET proficiency=? WHERE (emp_id, skill_id) VALUES (?, ?) ";
        int rs;
    ...
    {
        String sql = "DELETE FROM employeeskill WHERE (emp_id, skill_id) VALUES (?, ?)";
        int rs;
